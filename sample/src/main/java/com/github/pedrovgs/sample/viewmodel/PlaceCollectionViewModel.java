...
public class PlaceCollectionViewModel implements AdapteeCollection<PlaceViewModel> {
  ...
  @Inject public PlaceCollectionViewModel() {
    ...
    this.add(new PlaceViewModel("Sailing Stones, Death Valley",
        "http://static.environmentalgraffiti.com/sites/default/files/images/477px-20061205135618-DVNP-RACETRACKjpg",
        36.5047681, -117.0744727));
    this.add(new PlaceViewModel("The Wave, Arizona",
        "http://static.environmentalgraffiti.com/sites/default/files/images/wave3jpg.img_assist_custom-600x401.jpg",
        36.995629, -112.00613));
    this.add(new PlaceViewModel("Antelope Canyon, Arizona",
        "http://static.environmentalgraffiti.com/sites/default/files/images/450px-USAAntelope-Canyonjpg",
        36.861897, -111.374438));
    ...
    this.add(new PlaceViewModel("Bungle Bungles",
        "http://static.environmentalgraffiti.com/sites/default/files/images/bungle2jpg.img_assist_custom-600x454.jpg",
    ...
    this.add(new PlaceViewModel("Great Barrier Reef",
        "http://www.charterworld.com/news/wp-content/uploads/2012/08/Great-Barrier-Reef-one-of-the-most-fabulous-yacht-charter-destinations-in-Australia.jpg",
    ...
    this.add(new PlaceViewModel("Amazon Rain, Brazil",
        "http://1.bp.blogspot.com/-zjvjWNPQczI/TfRQTEYMk7I/AAAAAAAAAK8/W9SrwEyYPJw/s1600/rainforest.jpg",
    ...
    this.add(new PlaceViewModel("The Blue Grotto",
        "http://static.environmentalgraffiti.com/sites/default/files/images/800px-BlueGrottoCapriInsidejpg.img_assist_custom-600x450.jpg",
        40.91389, 14.208688));
