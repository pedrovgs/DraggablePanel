...
Download the project, compile it using maven or gradle and import ``draggablepanel-1.6.aar`` into your project.
...
```groovy
dependencies {
    compile 'com.github.pedrovgs:draggablepanel:1.6@aar'
