...
class ScaleTransformer extends Transformer {
    ...
    /**
     * @return true if the right position of the view is to the left of sixty percent of
     * the parent width.
     */
    @Override
    ...
    /**
     * @return true if the right position of the view is to the right of the one hundred twenty five five percent of the
     * parent view width.
     */
    @Override
